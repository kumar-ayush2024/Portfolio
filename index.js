...
function handleCommand(x){
    ...
    if (x=="command=show aboutme"){
        $(`#cR-${r}`).append(`<div class="ps-md-5 ps-1"><h3 class="text-white">Hi, I'm Kumar Ayush.</h3><p class="text-white mb-0">A Full Stack Developer and DevOps enthusiast.</p></div>`);
        
    }
    else if (x=="command=get contactme"){
        $(`#cR-${r}`).append(`<div class="ps-md-5 ps-1">
...
<p class="mb-0"><span class="text-white">Devops Tools: <span><span style="color:#63706C">Git, Github, Github Actions, Docker and Jenkins<span></p>
        ...
        $(`#cR-${r}`).append(`<div class="ps-md-5 ps-1">
<p class="mb-0"><span class="text-white">1. AWS Academy Cloud Foundations: <span><span style="color:#63706C"><a target="_blank" href="https://www.credly.com/badges/9c3b210f-4ba7-465a-8cde-fc15907fa1d5/public_url">Verify <i class="fa fa-external-link" style="font-size:13px"></i></a><span></p>
<p class="mb-0"><span class="text-white">2. Docker Foundations Professional Certificate: <span><span style="color:#63706C"><a target="_blank" href="https://www.linkedin.com/learning/certificates/52aa745d6704e3f0fd75e60a401a085f9ca825a44d2835eee24ca8318447fbc7?trk=share_certificate">Verify <i class="fa fa-external-link" style="font-size:13px"></i></a><span></p>
<p class="mb-0"><span class="text-white">3. GitHub Actions: <span><span style="color:#63706C"><a target="_blank" href="https://www.linkedin.com/learning/certificates/e46a5f3f338b63300ec25fcd65261caf4653c139c79478d6996dd7fcab824639?trk=share_certificate">Verify <i class="fa fa-external-link" style="font-size:13px"></i></a><span></p>
</div>`);
        }
    else{
        $(`#cR-${r}`).append(`<div class="ps-md-5 ps-1"><p class="mb-md-0 mb-0 text-danger">Unknown Command!!</p></div>`);
    }
    return
